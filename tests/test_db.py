...
class GeneralDatabaseTest(BaseDatabaseTest):
    ...
    def test_keys(self):
        ...
        self.assertTrue(response.is_ok())
        self.assertEqual(
            set(response.value), {"test_keys_1", "test_keys_2", "test_keys_3"}
        )
    ...
    def test_copy_to_overwrite(self):
        ...
        self.client.str_set(
            "test_copy_to_overwrite_2", "test_copy_to_overwrite_value_2"
        )
        response = self.client.copy_to(
            "test_copy_to_overwrite", "test_copy_to_overwrite_2"
        )
        self.assertTrue(response.is_ok())
    ...
    def test_copy_to_non_existent(self):
        ...
        """
        response = self.client.copy_to(
            "test_copy_to_non_existent", "test_copy_to_non_existent_2"
        )
        self.assertTrue(response.is_null())
    ...
    def test_move_to_overwrite(self):
        ...
        self.client.str_set(
            "test_move_to_overwrite_2", "test_move_to_overwrite_value_2"
        )
        response = self.client.move_to(
            "test_move_to_overwrite", "test_move_to_overwrite_2"
        )
        self.assertTrue(response.is_ok())
    ...
    def test_move_to_non_existent(self):
        ...
        """
        response = self.client.move_to(
            "test_move_to_non_existent", "test_move_to_non_existent_2"
        )
        self.assertTrue(response.is_null())
...
class GeneralDatabaseTestWithSwitching(BaseDatabaseTest):
    ...
    def test_copy_to_db_overwrite(self):
        ...
        """
        self.client.str_set(
            "test_copy_to_db_overwrite", "test_copy_to_db_overwrite_value"
        )
        self.client.switch_db(1)
        self.client.str_set(
            "test_copy_to_db_overwrite", "test_copy_to_db_overwrite_value_2"
        )
        self.client.switch_db(0)
    ...
    def test_move_to_db_overwrite(self):
        ...
        """
        self.client.str_set(
            "test_move_to_db_overwrite", "test_move_to_db_overwrite_value"
        )
        self.client.switch_db(1)
        self.client.str_set(
            "test_move_to_db_overwrite", "test_move_to_db_overwrite_value_2"
        )
        self.client.switch_db(0)
...
class PrimitiveDatabaseTest(BaseDatabaseTest):
    ...
    def test_many_get(self):
        ...
        response = self.client.many_get(
            "test_many_get_1", "test_many_get_2", "test_many_get_3"
        )
        self.assertTrue(response.is_ok())
        self.assertEqual(
            response.value,
            ["test_many_get_1_value", "test_many_get_2_value", "test_many_get_3_value"],
        )
    ...
    def test_many_get_non_existent(self):
        ...
        """
        self.client.str_set(
            "test_many_get_non_existent_1", "test_many_get_non_existent_1_value"
        )
        self.client.str_set(
            "test_many_get_non_existent_3", "test_many_get_non_existent_3_value"
        )
        response = self.client.many_get(
            "test_many_get_non_existent_1",
            "test_many_get_non_existent_2",
            "test_many_get_non_existent_3",
        )
        self.assertTrue(response.is_ok())
        self.assertEqual(
            response.value,
            [
                "test_many_get_non_existent_1_value",
                None,
                "test_many_get_non_existent_3_value",
            ],
        )
    ...
    def test_many_get_empty(self):
        ...
        """
        response = self.client.many_get(
            "test_many_get_empty_1", "test_many_get_empty_2", "test_many_get_empty_3"
        )
        self.assertTrue(response.is_ok())
    ...
    def test_many_get_int(self):
        ...
        response = self.client.many_get(
            "test_many_get_int_1", "test_many_get_int_2", "test_many_get_int_3"
        )
        self.assertTrue(response.is_ok())
        self.assertEqual(
            response.value,
            ["test_many_get_int_1_value", 123, "test_many_get_int_3_value"],
        )
    ...
    def test_many_get_float(self):
        ...
        response = self.client.many_get(
            "test_many_get_float_1", "test_many_get_float_2", "test_many_get_float_3"
        )
        self.assertTrue(response.is_ok())
        self.assertEqual(
            response.value,
            ["test_many_get_float_1_value", 123.456, "test_many_get_float_3_value"],
        )
    ...
    def test_many_get_mixed(self):
        ...
        response = self.client.many_get(
            "test_many_get_mixed_1",
            "test_many_get_mixed_2",
            "test_invalid",
            "test_many_get_mixed_3",
            "test_many_get_mixed_4",
            "test_many_get_mixed_5",
        )
        self.assertTrue(response.is_ok())
        self.assertEqual(
            response.value,
            [
                "test_many_get_mixed_1_value",
                123,
                None,
                123.456,
                "test_many_get_mixed_4_value",
                123.456,
            ],
        )
