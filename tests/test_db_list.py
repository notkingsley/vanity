...
class NonExistentDatabaseKeyTest(BaseDatabaseTest):
	...
	def test_non_existent_list_get(self):
		...
		self.assertEqual(response.body, "index out of range")
...
class WrongDatabaseKeyTypeTest(BaseDatabaseTest):
	...
	def test_wrong_type_list_len(self):
		...
		self.assertEqual(response.body, "not a list")
...
class NegativeIndicesTest(BaseDatabaseTest):
	...
	def test_list_pop_left(self):
		...
		self.assertTrue(response.is_ok())
		self.assertEqual(response.value, ["value1", "value2", "value3", "value4", "value5"])
	...
	def test_list_pop_right(self):
		...
		self.assertTrue(response.is_ok())
		self.assertEqual(response.value, ['value8', 'value9', 'value10', 'value11', 'value12'])
		response = self.client.list_len("test_list_negative_indices")
		self.assertTrue(response.is_ok())
		self.assertEqual(response.value, 7)
	...
	def test_list_range_negative_start(self):
		...
		self.assertTrue(response.is_ok())
		self.assertEqual(response.value, ["value6", "value7", "value8", "value9", "value10", "value11", "value12"])
	...
	def test_list_range_negative_end(self):
		...
		self.assertTrue(response.is_ok())
		self.assertEqual(response.value, ["value1", "value2", "value3", "value4", "value5", "value6", "value7", "value8", "value9", "value10", "value11"])
	...
	def test_list_range_negative_start_and_end(self):
		...
		self.assertTrue(response.is_ok())
		self.assertEqual(response.value, ["value6", "value7", "value8", "value9", "value10", "value11"])
	...
	def test_list_trim_negative_end(self):
		...
		response = self.client.list_range("test_list_negative_indices", 0, -1)
		self.assertTrue(response.is_ok())
		self.assertEqual(response.value, ["value1", "value2", "value3", "value4", "value5", "value6"])
	...
	def test_list_remove_negative(self):
		...
		response = self.client.list_range("test_list_negative_indices", 0, -1)
		self.assertTrue(response.is_ok())
		self.assertEqual(response.value, ["value1", "valuex", "value3", "value4", "value6", "value8", "value9", "value11", "value12"])
	...
	def test_list_remove_negative_zero(self):
		...
		response = self.client.list_range("test_list_negative_indices", 0, -1)
		self.assertTrue(response.is_ok())
		self.assertEqual(response.value, ["value1", "value3", "value4", "value6", "value8", "value9", "value11", "value12"])
