...
public:
	...
	void request_str_set(Client& client, const std::string& key, std::string value) override;

	// an int_set request was received from a client
	void request_int_set(Client& client, const std::string& key, int64_t value) override;

	// a float_set request was received from a client
	void request_float_set(Client& client, const std::string& key, double value) override;
